...
Then replace the `[URL HERE]` with a raw url to a Tamagotchi ROM (P1 or P2) in usigned_12 format (0xFA2, 0xC87, ...). Someone seems to have done the work for us: [P1 link](https://pastebin.com/raw/iN0pfyr7) or [P2 link](https://pastebin.com/raw/TXkwnBZA)
